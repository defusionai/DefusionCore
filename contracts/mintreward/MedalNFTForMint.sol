    ...
    ReentrancyGuard
{
    ...
    constructor() ERC721("DEFUSION.AI", "DEFUSIONAI") {
        baseURI = "";
    ...
    function mint(address to) external nonReentrant returns (uint256) {
        require(
            ...
            "DefusionAi: Caller is not a minter"
        );
    ...
    function tokenURI(
        ...
        require(
            _exists(tokenId),
            "DefusionAi: URI query for nonexistent token"
        );
